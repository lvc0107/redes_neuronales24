#!/usr/bin/env python3
"""
Created on Sat Sep 14 00:41:22 2024
...
def integrador_ode(m, f, xa, a, b, k, p, c=lambda x, t, p: x):
    ...
    w = np.zeros(
        (n, k + 1)
    )  # Produce un array con forma y tipo especificada con los parametros,
    # lleno de ceros. la forma puede ser espcificada con un entero o tupla (n,k+1)
    t = np.zeros(k + 1)
    w[
        :, 0
    ] = xa  # actualiza la posicion inicial (columna de indice 0) de las variables con los valores
