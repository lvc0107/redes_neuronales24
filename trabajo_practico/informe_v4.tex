...
Experimento 5: \textbf{Excitaciones espontáneas en respuesta al ruido}. Se utilizo la siguiente función de corriente:
$$
i5(t) = \left\{
 50 * i_0 \sim  N(0,1)$
\right.
...
Donde $i_0$ es un valor aleatorio obtenido de una distribución normal de media 0 y varianza 1). La constante 50 es un valor arbitrario para lograr cantidades de $uA$ en un rango de valores bastante espaciados.
Por ser un proceso estocástico se integro numéricamente usando el método de Euler.\\

La corriente en este experimento se modela como un flujo de impulsos aleatorios. En fig.~\ref{fig9} se puede ver que la frecuencia de activaciones del potencial no son del todo uniformes. Esto se debe al componente aleatorio que introduce la función del ruido.\\
